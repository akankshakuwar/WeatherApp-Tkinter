...
class Weather(Tk):
    ...
    def __gui(self):
        ...
        # location label
        self.location = Label(text=' ', font='arial 15')
        ...
        Button(text='Exit', font=("Georgia", 16, "bold"), bg='white', fg='black', width=7, relief='groove',
               command=self.exit).place(x=680, y=420)
        Button(text='Reset', font=("Georgia", 16, "bold"), bg='white', fg='black', width=7, relief='groove',
